...
public class TemplateModifieritemsImpl extends ASTWrapperPsiElement implements TemplateModifieritems {

  public TemplateModifieritemsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TemplateVisitor visitor) {
    visitor.visitModifieritems(this);
  }
